...
// Last edited date : Sat, 23 Jul 2016 16:33:17 +0000
// --------------------------------------------------------------------------------

$l['nav_online'] = 'Kas prisijungę';
$l['nav_onlinetoday'] = 'Kas buvo prisijungę šiandien';
$l['viewing_announcements'] = 'Žiūri skelbimą <a href="{1}">{2}</a>';
$l['viewing_announcements2'] = 'Žiūri skelbimą';
$l['viewing_attachment'] = 'Žiūri priedą';
$l['viewing_attachment2'] = 'Žiūri <a href="attachment.php?aid={1}" target="_blank">Priedą</a>Temoje <a href="{3}">{2}</a>';
$l['viewing_calendar'] = 'Žiūri <a href="calendar.php">Kalendorių</a>';
$l['viewing_event'] = 'Žiūri įvykį';
$l['viewing_event2'] = 'Žiūri įvykį <a href="{1}">{2}</a>';
$l['adding_event'] = '<a href="calendar.php?action=addevent">Kurią įvykį</a>';
$l['editing_event'] = 'Redaguoja įvykį';
$l['viewing_contact_us'] = 'Žiūri <a href="contact.php">Kontaktus</a>';
$l['editing_post'] = 'Redaguoja pranešimą';
$l['viewing_forum'] = 'Žiūri forumą';
$l['viewing_forum2'] = 'Žiūri forumą <a href="{1}">{2}</a>';
$l['forum_redirect_to'] = 'Buvo nukreipti į <a href="{1}">{2}</a>';
$l['viewing_index'] = '{1} <a href="index.php">Pagrindinis</a>';
...
$l['guest'] = 'Svečias';
$l['page'] = 'Puslapis';
$l['users_online'] = 'Kas prisijungę';
$l['on_username'] = 'Vartotojo vardas';
$l['time'] = 'Laikas';
$l['location'] = 'Vieta';
$l['online_today'] = 'Kas buvo prisijungę šiandien';
$l['refresh_page'] = 'Prekrauti šį puslapį';
